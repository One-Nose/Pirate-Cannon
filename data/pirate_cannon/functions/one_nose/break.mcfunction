...
execute at @e[tag=one_nose_pirate_cannon_broken] run summon minecraft:item ~ ~1 ~ {Item:{id:"minecraft:gunpowder",Count:1b}}
execute at @e[tag=one_nose_pirate_cannon_broken] run summon minecraft:item ~ ~1 ~ {Item:{id:"minecraft:iron_block",Count:1b}}
